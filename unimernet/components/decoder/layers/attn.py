...
from transformers.models.bart.modeling_bart import BartAttention, BartFlashAttention2


class SqueezeAttention(BartAttention):
    ...
    def __init__(
        ...
        super().__init__(embed_dim, num_heads, dropout,
                         is_decoder, bias, is_causal, config)
        ...
        # use squeezed dim for q and k proj
